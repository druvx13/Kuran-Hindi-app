package com.muslim.Search.model;
/* loaded from: classes.dex */
public class SearchQuranDetails {
    public String content;
    public String id;
    public String modified_content;
    public String sura_id;
    public String trans;
    public String verses_id;
    ...
    public String getVerses_id() {
        return this.verses_id;
    }

    public void setVerses_id(String str) {
        this.verses_id = str;
    }
