...
public final class zzo {
    ...
    public final void zza(zzuj zzujVar, zzazz zzazzVar) {
        this.zzbmy = zzujVar.zzcel.zzbmy;
        Bundle bundle = zzujVar.zzcen != null ? zzujVar.zzcen.getBundle(AdMobAdapter.class.getName()) : null;
        if (bundle == null) {
            return;
        }
        ...
        this.zzbmx.put("SDKVersion", zzazzVar.zzbnd);
