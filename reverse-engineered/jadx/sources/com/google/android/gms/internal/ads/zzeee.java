...
public interface zzeee {
    ...
    <T> T zza(zzeek<T> zzeekVar, zzebq zzebqVar) throws IOException;

    <T> void zza(List<T> list, zzeek<T> zzeekVar, zzebq zzebqVar) throws IOException;

    <K, V> void zza(Map<K, V> map, zzedf<K, V> zzedfVar, zzebq zzebqVar) throws IOException;

    @Deprecated
    <T> T zzb(zzeek<T> zzeekVar, zzebq zzebqVar) throws IOException;

    @Deprecated
    <T> void zzb(List<T> list, zzeek<T> zzeekVar, zzebq zzebqVar) throws IOException;
