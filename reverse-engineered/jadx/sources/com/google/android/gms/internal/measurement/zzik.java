            ...
            if (zzd) {
                ...
                if (!zze) {
                    ...
                    if (zzf) {
                        if (i6 < i3 - 1) {
                            int i8 = i6 + 1;
                            zzig.zzb(zza2, zzib.zza(bArr, i6), zzib.zza(bArr, i8), cArr, i5);
                            i = i8 + 1;
                            i5++;
                        } else {
                            throw zzfo.zzh();
                        ...
                        int i9 = i6 + 1;
                        int i10 = i9 + 1;
                        zzig.zzb(zza2, zzib.zza(bArr, i6), zzib.zza(bArr, i9), zzib.zza(bArr, i10), cArr, i5);
                        i = i10 + 1;
                        i5 = i5 + 1 + 1;
                    } else {
                        throw zzfo.zzh();
        ...
        while (i4 < length) {
            ...
            if (charAt3 >= c || j4 >= j5) {
                if (charAt3 < 2048 && j4 <= j5 - 2) {
                    long j6 = j4 + j;
                    zzib.zza(bArr, j4, (byte) ((charAt3 >>> 6) | 960));
                    zzib.zza(bArr, j6, (byte) ((charAt3 & '?') | 128));
                    j2 = j6 + j;
                    j3 = j;
                    ...
                    if (j4 <= j5 - 4) {
                        ...
                        if (i5 != length) {
                            ...
                            if (Character.isSurrogatePair(charAt3, charAt4)) {
                                ...
                                long j7 = j4 + 1;
                                zzib.zza(bArr, j4, (byte) ((codePoint >>> 18) | 240));
                                long j8 = j7 + 1;
                                zzib.zza(bArr, j7, (byte) (((codePoint >>> 12) & 63) | 128));
                                long j9 = j8 + 1;
                                zzib.zza(bArr, j8, (byte) (((codePoint >>> 6) & 63) | 128));
                                j3 = 1;
                                j2 = j9 + 1;
                                zzib.zza(bArr, j9, (byte) ((codePoint & 63) | 128));
                                i4 = i5;
                            } else {
                                i4 = i5;
                            }
                    ...
                    long j10 = j4 + j;
                    zzib.zza(bArr, j4, (byte) ((charAt3 >>> '\f') | 480));
                    long j11 = j10 + j;
                    zzib.zza(bArr, j10, (byte) (((charAt3 >>> 6) & 63) | 128));
                    zzib.zza(bArr, j11, (byte) ((charAt3 & '?') | 128));
                    j2 = j11 + 1;
                    j3 = 1;
                }
                i4++;
