...
final class zzis {
    ...
    public final void zzfk() {
        ...
        float f = this.zzahf;
        float f2 = this.zzahg;
        int i3 = this.zzamp + ((int) ((((i2 / (f / f2)) + this.zzamq) / f2) + 0.5f));
        zzx((this.zzame * 2) + i2);
        int i4 = 0;
        while (true) {
            i = this.zzame;
                ...
                while (true) {
                    ...
                    if (i11 > 0) {
                        ...
                        if (this.zzamb == i8 && i13 == i8) {
                            i = zza(sArr, i10, this.zzamc, this.zzamd);
                        } else {
                            zzb(sArr, i10, i13);
                        ...
                        int i20 = this.zzamu;
                        int i21 = i20 != 0 && this.zzams != 0 && this.zzamv <= i20 * 3 && (i20 << 1) > this.zzamt * 3 ? this.zzams : i;
                        ...
                        if (d > 1.0d) {
                            ...
                            if (f >= 2.0f) {
                                ...
                                this.zzamr = (int) ((i21 * (2.0f - f)) / (f - 1.0f));
                                i3 = i21;
                            }
                            zzw(i3);
                            int i22 = i3;
                            zza(i3, this.zzamb, this.zzamj, this.zzamp, sArr2, i10, sArr2, i10 + i21);
                            this.zzamp += i22;
                            i10 += i21 + i22;
                        } else {
                            int i23 = i21;
                            ...
                            if (f < 0.5f) {
                                ...
                                this.zzamr = (int) ((i23 * ((2.0f * f) - 1.0f)) / (1.0f - f));
                                i2 = i23;
                            }
                            int i24 = i23 + i2;
                            zzw(i24);
                            ...
                            zza(i2, this.zzamb, this.zzamj, this.zzamp + i23, sArr3, i23 + i10, sArr3, i10);
                            this.zzamp += i24;
                            i10 += i2;
                        }
                    }
