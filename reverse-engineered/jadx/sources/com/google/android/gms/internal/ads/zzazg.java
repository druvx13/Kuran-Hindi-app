...
final class zzazg implements Callable<String> {
    private final /* synthetic */ Context val$context;

    /* JADX INFO: Access modifiers changed from: package-private */
    public zzazg(zzazd zzazdVar, Context context) {
    ...
    public final /* synthetic */ String call() throws Exception {
        ...
        if (TextUtils.isEmpty(string)) {
            zzawr.zzeg("User agent is not initialized on Google Play Services. Initializing.");
        ...
        zzawr.zzeg("User agent is already initialized on Google Play Services.");
        return string;
    }
}
