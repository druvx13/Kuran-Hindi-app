...
public final class zzayu {
    ...
    public static String zza(zzayv zzayvVar) {
        return zzk(zzayvVar);
    }
    ...
    private static String zzk(Object obj) {
        ...
        try {
            ...
            zzawr.zzc("Error when writing JSON.", e);
            return null;
        }
    }
    ...
    private static void zza(JsonWriter jsonWriter, Object obj) throws IOException {
        if (obj == null) {
            ...
            jsonWriter.value((String) obj);
        } else if (obj instanceof zzayv) {
            ((zzayv) obj).zza(jsonWriter);
                ...
                if (opt instanceof Boolean) {
                    ...
                    if (jSONArray != null && jSONArray.length() != 0) {
                        ...
                        if (obj == null) {
                            ...
                            zzawr.zzfc(valueOf.length() != 0 ? "Expected JSONArray with at least 1 non-null element for key:".concat(valueOf) : new String("Expected JSONArray with at least 1 non-null element for key:"));
                        } else if (obj instanceof JSONObject) {
                            Parcelable[] parcelableArr = new Bundle[length];
                            while (i < length) {
                                parcelableArr[i] = !jSONArray.isNull(i) ? zzh(jSONArray.optJSONObject(i)) : null;
                                i++;
                            }
                            ...
                            zzawr.zzfc(String.format("JSONArray with unsupported type %s for key:%s", obj.getClass().getCanonicalName(), next));
                        }
                    }
                    ...
                    zzawr.zzfc(valueOf2.length() != 0 ? "Unsupported type for key:".concat(valueOf2) : new String("Unsupported type for key:"));
                }
            }
        }
        return bundle;
