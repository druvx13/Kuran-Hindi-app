...
public final class zzavu extends zzgi implements zzavs {
    ...
    public final zzavn zzf(IObjectWrapper iObjectWrapper, int i) throws RemoteException {
        zzavn zzavpVar;
        ...
        if (readStrongBinder == null) {
            ...
            if (queryLocalInterface instanceof zzavn) {
                zzavpVar = (zzavn) queryLocalInterface;
            } else {
                zzavpVar = new zzavp(readStrongBinder);
            }
        }
