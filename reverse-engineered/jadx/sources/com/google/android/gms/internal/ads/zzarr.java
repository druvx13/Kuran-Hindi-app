...
public final class zzarr {
    ...
    public zzarr(Context context) {
        ...
        this.zzdqi = zza(packageManager, "http://www.google.com") != null;
    ...
    public zzarr(Context context, zzars zzarsVar) {
        ...
        this.zzdqh = zzarsVar.zzdqh;
        this.zzdqi = zzarsVar.zzdqi;
        this.zzdqj = zzarsVar.zzdqj;
        this.zzdqk = zzarsVar.zzdqk;
        this.zzdql = zzarsVar.zzdql;
        this.zzdqm = zzarsVar.zzdqm;
        this.zzdqn = zzarsVar.zzdqn;
        this.zzdqo = zzarsVar.zzdqo;
        this.zzdqp = zzarsVar.zzdqp;
        this.zzbpk = zzarsVar.zzbpk;
        this.zzdji = zzarsVar.zzdji;
        this.zzdjj = zzarsVar.zzdjj;
    }
    ...
    private final void zzt(Context context) {
        ...
        if (audioManager != null) {
            try {
                ...
                com.google.android.gms.ads.internal.zzq.zzla().zza(th, "DeviceInfo.gatherAudioInfo");
            }
        }
        this.zzdpr = -2;
        this.zzdps = false;
    ...
    private final void zzv(Context context) {
        ...
        if (registerReceiver != null) {
            ...
            this.zzdqd = registerReceiver.getIntExtra(FirebaseAnalytics.Param.LEVEL, -1) / registerReceiver.getIntExtra("scale", -1);
            this.zzdqe = (intExtra == 2 || intExtra == 5) ? true : true;
            return;
        }
        this.zzdqd = -1.0d;
        this.zzdqe = false;
    ...
    private static ResolveInfo zza(PackageManager packageManager, String str) {
        try {
            ...
            com.google.android.gms.ads.internal.zzq.zzla().zza(th, "DeviceInfo.getResolveInfo");
            return null;
        }
    }
