...
public final class zzcgk implements zzegz<zzbvt<zzbuf>> {
    ...
    private zzcgk(zzehm<zzcgs> zzehmVar, zzehm<Executor> zzehmVar2) {
        this.zzfhv = zzehmVar;
        this.zzenm = zzehmVar2;
    }

    public static zzcgk zzv(zzehm<zzcgs> zzehmVar, zzehm<Executor> zzehmVar2) {
        return new zzcgk(zzehmVar, zzehmVar2);
    }
