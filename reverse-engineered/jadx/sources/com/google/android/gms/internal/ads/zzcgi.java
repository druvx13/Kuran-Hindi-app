...
public final class zzcgi implements zzegz<zzbvt<zzbrc>> {
    ...
    private zzcgi(zzehm<zzcgs> zzehmVar, zzehm<Executor> zzehmVar2) {
        this.zzfhv = zzehmVar;
        this.zzenm = zzehmVar2;
    }

    public static zzcgi zzt(zzehm<zzcgs> zzehmVar, zzehm<Executor> zzehmVar2) {
        return new zzcgi(zzehmVar, zzehmVar2);
    }
