...
final /* synthetic */ class zzcyg implements Callable {
    static final Callable zzgnf = new zzcyg();
    ...
    public final Object call() {
        ...
        if (((Boolean) zzvj.zzpv().zzd(zzzz.zzcjv)).booleanValue()) {
        ...
        bundle.putInt("web_view_count", com.google.android.gms.ads.internal.zzq.zzla().zzwa());
        return new zzcye(bundle);
    }
}
