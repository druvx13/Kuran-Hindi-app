...
public final class zzbks implements zzegz<Set<zzbvt<zzbrp>>> {
    ...
    private zzbks(zzehm<zzbkp> zzehmVar, zzehm<Executor> zzehmVar2, zzehm<JSONObject> zzehmVar3) {
        this.zzfhv = zzehmVar;
        this.zzenm = zzehmVar2;
        this.zzfhw = zzehmVar3;
    }

    public static zzbks zza(zzehm<zzbkp> zzehmVar, zzehm<Executor> zzehmVar2, zzehm<JSONObject> zzehmVar3) {
        return new zzbks(zzehmVar, zzehmVar2, zzehmVar3);
    }
