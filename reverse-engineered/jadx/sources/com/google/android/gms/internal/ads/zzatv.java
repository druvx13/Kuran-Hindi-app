...
public final class zzatv {
    public static zzatf zzd(Context context, String str, zzalp zzalpVar) {
        try {
            IBinder zzd = ((zzatl) zzazv.zza(context, "com.google.android.gms.ads.rewarded.ChimeraRewardedAdCreatorImpl", zzaty.zzbvh)).zzd(ObjectWrapper.wrap(context), str, zzalpVar, 201004000);
            if (zzd == null) {
                return null;
            }
