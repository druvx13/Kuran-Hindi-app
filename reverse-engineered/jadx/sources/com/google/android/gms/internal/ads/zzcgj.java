...
public final class zzcgj implements zzegz<zzbvt<zzub>> {
    ...
    private zzcgj(zzehm<zzcgs> zzehmVar, zzehm<Executor> zzehmVar2) {
        this.zzfhv = zzehmVar;
        this.zzenm = zzehmVar2;
    }

    public static zzcgj zzu(zzehm<zzcgs> zzehmVar, zzehm<Executor> zzehmVar2) {
        return new zzcgj(zzehmVar, zzehmVar2);
    }
