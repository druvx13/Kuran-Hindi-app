...
public final class zzaya {
    ...
    private static String zzh(Context context, String str, String str2) {
        ...
        hashMap.put("User-Agent", com.google.android.gms.ads.internal.zzq.zzkw().zzr(context, str2));
        zzdri<String> zzc = new zzaym(context).zzc(str, hashMap);
        try {
            return zzc.get(((Integer) zzvj.zzpv().zzd(zzzz.zzcqk)).intValue(), TimeUnit.MILLISECONDS);
        } catch (InterruptedException e) {
            String valueOf = String.valueOf(str);
            zzawr.zzc(valueOf.length() != 0 ? "Interrupted while retriving a response from: ".concat(valueOf) : new String("Interrupted while retriving a response from: "), e);
            zzc.cancel(true);
            return null;
        } catch (TimeoutException e2) {
            String valueOf2 = String.valueOf(str);
            zzawr.zzc(valueOf2.length() != 0 ? "Timeout while retriving a response from: ".concat(valueOf2) : new String("Timeout while retriving a response from: "), e2);
            zzc.cancel(true);
            return null;
        } catch (Exception e3) {
    ...
    public final boolean zzb(Context context, String str, String str2, String str3) {
        if (TextUtils.isEmpty(str2) || !com.google.android.gms.ads.internal.zzq.zzlg().zzxu()) {
            return false;
        }
