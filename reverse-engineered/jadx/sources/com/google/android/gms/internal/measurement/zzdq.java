...
public final class zzdq {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static int zzc(byte[] bArr, int i, zzdt zzdtVar) throws zzfo {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static int zzd(byte[] bArr, int i, zzdt zzdtVar) throws zzfo {
        int zza = zza(bArr, i, zzdtVar);
        int i2 = zzdtVar.zza;
        if (i2 >= 0) {
            if (i2 == 0) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static int zze(byte[] bArr, int i, zzdt zzdtVar) throws zzfo {
        int zza = zza(bArr, i, zzdtVar);
        int i2 = zzdtVar.zza;
        if (i2 < 0) {
            throw zzfo.zzb();
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static int zza(zzhd zzhdVar, byte[] bArr, int i, int i2, zzdt zzdtVar) throws IOException {
        int i3 = i + 1;
        int i4 = bArr[i];
        if (i4 < 0) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static int zza(zzhd zzhdVar, byte[] bArr, int i, int i2, int i3, zzdt zzdtVar) throws IOException {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static int zza(byte[] bArr, int i, zzfl<?> zzflVar, zzdt zzdtVar) throws IOException {
        zzfg zzfgVar = (zzfg) zzflVar;
        int zza = zza(bArr, i, zzdtVar);
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static int zza(zzhd<?> zzhdVar, int i, byte[] bArr, int i2, int i3, zzfl<?> zzflVar, zzdt zzdtVar) throws IOException {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static int zza(int i, byte[] bArr, int i2, int i3, zzhy zzhyVar, zzdt zzdtVar) throws zzfo {
        if ((i >>> 3) != 0) {
            int i4 = i & 7;
            if (i4 == 0) {
                ...
                while (true) {
                    ...
                    int zza3 = zza(i7, bArr, zza2, i3, zzb2, zzdtVar);
                    i7 = i8;
                    i2 = zza3;
                }
                if (i2 > i3 || i7 != i6) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static int zza(int i, byte[] bArr, int i2, int i3, zzdt zzdtVar) throws zzfo {
        if ((i >>> 3) != 0) {
            int i4 = i & 7;
            if (i4 != 0) {
                if (i4 != 1) {
