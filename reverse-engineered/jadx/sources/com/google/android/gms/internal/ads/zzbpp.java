...
public final class zzbpp implements zzegz<zzbvt<zzbrb>> {
    ...
    private zzbpp(zzehm<zzchn> zzehmVar, zzehm<Executor> zzehmVar2) {
        this.zzfhv = zzehmVar;
        this.zzenm = zzehmVar2;
    }

    public static zzbpp zzj(zzehm<zzchn> zzehmVar, zzehm<Executor> zzehmVar2) {
        return new zzbpp(zzehmVar, zzehmVar2);
    }
