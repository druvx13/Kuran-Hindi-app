...
public interface zzhe {
    ...
    <T> T zza(zzhd<T> zzhdVar, zzeq zzeqVar) throws IOException;

    void zza(List<Double> list) throws IOException;

    <T> void zza(List<T> list, zzhd<T> zzhdVar, zzeq zzeqVar) throws IOException;

    <K, V> void zza(Map<K, V> map, zzgf<K, V> zzgfVar, zzeq zzeqVar) throws IOException;

    int zzb();

    @Deprecated
    <T> T zzb(zzhd<T> zzhdVar, zzeq zzeqVar) throws IOException;

    void zzb(List<Float> list) throws IOException;

    @Deprecated
    <T> void zzb(List<T> list, zzhd<T> zzhdVar, zzeq zzeqVar) throws IOException;
