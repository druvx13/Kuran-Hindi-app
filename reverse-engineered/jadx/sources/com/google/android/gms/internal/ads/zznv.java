...
public final class zznv {
    ...
    private zznv(Uri uri, int i) {
        this(uri, 0L, -1L, null, 0);
    }

    public zznv(Uri uri, long j, long j2, String str) {
        this(uri, j, j, j2, str, 0);
    }

    private zznv(Uri uri, long j, long j2, String str, int i) {
        this(uri, 0L, 0L, -1L, null, 0);
    }

    private zznv(Uri uri, long j, long j2, long j3, String str, int i) {
        this(uri, null, j, j2, j3, str, i);
    }

    public zznv(Uri uri, byte[] bArr, long j, long j2, long j3, String str, int i) {
        boolean z = true;
