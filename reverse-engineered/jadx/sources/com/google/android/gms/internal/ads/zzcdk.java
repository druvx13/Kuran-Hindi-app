...
public final class zzcdk implements zzegz<zzcdl> {
    ...
    private zzcdk(zzehm<String> zzehmVar, zzehm<zzbzm> zzehmVar2, zzehm<zzbzx> zzehmVar3) {
        this.zzfmz = zzehmVar;
        this.zzfwa = zzehmVar2;
        this.zzfqt = zzehmVar3;
    }

    public static zzcdk zzl(zzehm<String> zzehmVar, zzehm<zzbzm> zzehmVar2, zzehm<zzbzx> zzehmVar3) {
        return new zzcdk(zzehmVar, zzehmVar2, zzehmVar3);
    }
