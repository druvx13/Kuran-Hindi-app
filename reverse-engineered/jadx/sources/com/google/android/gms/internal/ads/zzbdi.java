...
public final class zzbdi implements zzaga<zzbbx> {
    ...
    private static void zza(zzbbk zzbbkVar, Map<String, String> map) {
        ...
        if (str != null) {
            try {
                zzbbkVar.zzde(Integer.parseInt(str));
            } catch (NumberFormatException unused) {
                zzawr.zzfc(String.format("Could not parse buffer parameters in loadControl video GMSG: (%s, %s)", str, str2));
                return;
            }
        }
        if (str2 != null) {
            zzbbkVar.zzdf(Integer.parseInt(str2));
        }
        if (str3 != null) {
            zzbbkVar.zzdg(Integer.parseInt(str3));
        }
        if (str4 != null) {
            zzbbkVar.zzdh(Integer.parseInt(str4));
        }
        if (str5 != null) {
            zzbbkVar.zzdi(Integer.parseInt(str5));
        }
    }
    ...
    public final /* synthetic */ void zza(zzbbx zzbbxVar, Map map) {
        ...
        if ("background".equals(str)) {
            ...
            try {
                zzbbxVar2.setBackgroundColor(Color.parseColor(str2));
                return;
        ...
        if ("decoderProps".equals(str)) {
            ...
            if (str3 == null) {
                ...
                zzbbk.zza(zzbbxVar2, "missingMimeTypes");
                return;
            }
            ...
            zzbbk.zza(zzbbxVar2, hashMap);
            return;
        }
        zzbbq zzze = zzbbxVar2.zzze();
        if (zzze == null) {
        ...
        if (equals || equals2) {
            Context context = zzbbxVar2.getContext();
            int zza = zza(context, map, "x", 0);
            int zza2 = zza(context, map, "y", 0);
            int zza3 = zza(context, map, "w", -1);
            int zza4 = zza(context, map, "h", -1);
            int min = Math.min(zza3, zzbbxVar2.zzzm() - zza);
            int min2 = Math.min(zza4, zzbbxVar2.zzzl() - zza2);
            try {
        ...
        if (zzza2 == null) {
            ...
            Context context2 = zzbbxVar2.getContext();
            ...
            Context context3 = zzbbxVar2.getContext();
            zzza2.zza(zza(context3, map, "dx", 0), zza(context3, map, "dy", 0));
            if (this.zzegl) {
                return;
            }
            zzbbxVar2.zzun();
