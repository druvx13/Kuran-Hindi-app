...
public class zzhi<K extends Comparable<K>, V> extends AbstractMap<K, V> {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static <FieldDescriptorType extends zzey<FieldDescriptorType>> zzhi<FieldDescriptorType, Object> zza(int i) {
        return new zzhh(i);
    }
    ...
    public boolean containsKey(Object obj) {
        ...
        return zza((zzhi<K, V>) comparable) >= 0 || this.zzc.containsKey(comparable);
    }
    ...
    public V get(Object obj) {
        Comparable comparable = (Comparable) obj;
        int zza = zza((zzhi<K, V>) comparable);
        if (zza >= 0) {
    ...
    public /* synthetic */ Object put(Object obj, Object obj2) {
        return zza((zzhi<K, V>) ((Comparable) obj), (Comparable) obj2);
    }
