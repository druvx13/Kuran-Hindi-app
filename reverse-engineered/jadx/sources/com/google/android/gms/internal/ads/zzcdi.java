...
public final class zzcdi implements zzegz<zzcdj> {
    ...
    private zzcdi(zzehm<String> zzehmVar, zzehm<zzbzm> zzehmVar2, zzehm<zzbzx> zzehmVar3) {
        this.zzfmz = zzehmVar;
        this.zzfwa = zzehmVar2;
        this.zzfqt = zzehmVar3;
    }

    public static zzcdi zzk(zzehm<String> zzehmVar, zzehm<zzbzm> zzehmVar2, zzehm<zzbzx> zzehmVar3) {
        return new zzcdi(zzehmVar, zzehmVar2, zzehmVar3);
    }
