...
public final class zzcak implements zzegz<zzbvt<zzbtb>> {
    ...
    private zzcak(zzehm<zzctk> zzehmVar, zzehm<Executor> zzehmVar2) {
        this.zzfhv = zzehmVar;
        this.zzenm = zzehmVar2;
    }

    public static zzcak zzr(zzehm<zzctk> zzehmVar, zzehm<Executor> zzehmVar2) {
        return new zzcak(zzehmVar, zzehmVar2);
    }
